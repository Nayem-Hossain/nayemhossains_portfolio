  ...
  return (
    ...
    >
      <div className="lg:w-1/2">
        ...
        <h1 id="full-name">
          Hi, I’m <span className="color-name">Nayem Hossain</span>
        </h1>
        <TypewritterAnimation></TypewritterAnimation>
        <p className="descriptions mt-8 mb-14 paragraph text-justify">
        ...
        <div
          className="lg:flex grid grid-flow-row gap-4"
          data-aos="fade-up"
      ...
      >
        <img
          ...
          className="xm:mb-4 border-4 border-solid border-CustomeArc rounded-full m-auto"
        />
      </div>
    </section>
  );
