        ...
        <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
          <div className="text-white lg:w-1/2 lg:mx-6">
            ...
            <p className="max-w-xl mt-6">
              Ask us anything about works and I would love to hear from you
            </p>

            <div className="mt-6 space-y-8 md:mt-8">
              <p className="flex items-start -mx-2 rounded-lg shadow-xl px-2 py-1">
                <svg
            ...
            <div className="mt-6 md:mt-8">
              <h3 className="px-2 py-1">Follow Me :</h3>
              ...
              <div className="flex mt-4 -mx-1.5">
                ...
                <a
                  className="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500"
                  href="https://www.instagram.com/__nayem_hossain7/"
                >
                  <svg
                    className="w-8 h-8"
                    viewBox="0 0 24 24"
            ...
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-[#191d24] lg:max-w-xl">
              ...
              <form className="mt-6">
                ...
                <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gradient-to-r from-[#2361ff] to-[#07f7f7] rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                  Send Email <i className="fa-solid fa-paper-plane ml-1"></i>
                </button>
              </form>
            </div>
          </div>
